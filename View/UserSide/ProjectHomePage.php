...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="ProjectExhibits.php">Exhibits</a></li>
            <li><a href="ProjectEvents.php">Events</a></li>
            <li><a href="ProjectVisit.php">Visit</a></li>
            <li><a href="ProjectContacts.php">Contact Us</a></li>
        </ul>
    </nav>

    <section class="hero-container">
    <div class="hero-image">
        <img src="../../Multimedia/Images/home-page-image.jpg" alt="Exhibition Image" title="this is a sample image">
    </div>
    
    <div class="home-page-content">
        <h1 class="Welcome-Guest-Likha">Title here</h1>
        <p>
            The quick brown fox jumps over the lazy dog. The quick brown fox jumps over the 
            lazy dog. The quick brown fox jumps over the lazy dog. The quick brown fox 
            jumps over the lazy dog.
        </p>
        <a class="btn btn-login" href="ProjectVisit.php">Book Now</a>
    </div>
</section>
