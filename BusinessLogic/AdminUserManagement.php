<?php
    ...
    require_once __DIR__ . '/../Model/Admins/AdminRegistrationModel.php';
    ...
    class AdminUserManagement {
        ...
        public function __construct() {
            ...
            $this -> registrationModel = new AdminRegistration($db);
        }
        ...
        public function logoutUserFunc() {
            $this -> initializeSessionUserArray();
        ...
        public function getMonthCreated() {
            $response = $this -> registrationModel -> EmployeeMonthCreatedAcc();
            return $response -> fetchAll(PDO::FETCH_ASSOC);
        }

        public function getAdminLoginsMonths() {
            $response = $this -> registrationModel -> LastLoginsCountMonth();
            return $response -> fetchAll(PDO::FETCH_ASSOC);
        }
        ...
        public function getAdminLoginsCurrentMonth() {
            $response = $this -> registrationModel -> cardLoginsCurrentMonth();
            return $response -> fetch(PDO::FETCH_ASSOC);
        }
